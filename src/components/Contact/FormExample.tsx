...
const FormExample = function (): JSX.Element {
    ...
    <div className="formexample __block">
      ...
      <div className={classes.sampleSection}>
        ...
        <Tooltip title="Copy the Data" aria-label="copy">
          <CopyToClipboard className={classes.copyIcon} text={codeSnippet} onCopy={onCopyText}>
            <Typography>{isCopied ? 'Copied!' : <FileCopyIcon />}</Typography>
          </CopyToClipboard>
        </Tooltip>
      </div>
      <Alert severity="warning">
        꼭 샘플데로 대소문자 구분해서 보내주세요 국가별 코드는 위의 입력란 참조해주세요!
        <a href="">(국가별 코드 찾기)</a>
      </Alert>
      ...
      <div className={classes.explain}>
        ...
        <Typography variant="subtitle2">
          If you want to send us multiple Racism Report Data, you can copy over the example(Multiple Data exmaple). And please send directly our E-Mail &nbsp;
